...
class GameEndFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(correctAnswerAmount > 2) {
            ...
            notificationText = "You have scored more than 2 points, you can view your result at leaderboard."

            NotificationHelper(binding.root.context).createNotification(notificationTitle,notificationText)
            ...
            notificationText = "If you want your name to be displayed in leaderboards, score more than 2 points!"
            NotificationHelper(binding.root.context).createNotification(notificationTitle,notificationText)
        }
